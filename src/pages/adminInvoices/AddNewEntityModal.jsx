...
export default function AddNewEntityModal(props) {
  // userData;
  ...
  let initObj = {
    ...
    duedt: '',
    limitexp: '',
    createdt: data?.createdAt,
    approvallimit: data?.approvedLimit,
    arrname: '',
    invurl: '',
    relationship: data?.tcapRelation,
  ...
  const onChangeUploadFile = (e) => {
    setState({ ...state, uploadfile: e.target.files[0] });
  };
          ...
          /> */}
                      ...
                      <Grid item xs={6}>
                        <div className="addInvItem">
                          ...
                          />
                         <label style={{float:'right'}}>{state.uploadfile.name}</label>
                        </div>
                      </Grid>
                      <Grid item xs={6}>
                        <div className="addInvItem">
